...
常见场景是，用户想让一个第三方应用访问自己在某个平台上的部分资源，但又不想把账号密码直接交给它，这时候就会用到 OAuth。
...
核心思路就是在客户端和服务提供方之间加一层授权。

客户端不直接拿用户账号密码去登录服务提供方，而是先拿授权，再换 token，最后拿 token 去访问资源。
...
<img src="/images/oauth/authorization-code.svg" alt="OAuth authorization code flow" style="width: 100%; max-width: 760px; height: auto;">
...
<img src="/images/oauth/implicit.svg" alt="OAuth implicit flow" style="width: 100%; max-width: 760px; height: auto;">
...
<img src="/images/oauth/password.svg" alt="OAuth password flow" style="width: 100%; max-width: 760px; height: auto;">
...
<img src="/images/oauth/client-credentials.svg" alt="OAuth client credentials flow" style="width: 100%; max-width: 760px; height: auto;">
